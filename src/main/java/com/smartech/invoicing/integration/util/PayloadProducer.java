...
public class PayloadProducer {
	...
	public static String getArReportInvoice(String sessionId, String date) {
		String SOAPRequest = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:v7=\"urn://oracle.bi.webservices/v7\">\r\n" + 
				...
				"   \"Receivables - Transactions Real Time\".\"- General Information\".\"Transaction Number\" s_9,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- General Information\".\"Transaction Source Name\" s_10,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- General Information\".\"Transaction Type\" s_11,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- Line Information\".\"Sales Order Number\" s_12,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- Line Information\".\"Transaction Line Number\" s_13,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- Line Information\".\"Unit Of Measure Code\" s_14,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- Line Information\".\"Unit Selling Price\" s_15,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- Main\".\"Item Description\" s_16,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- Main\".\"Item Name\" s_17,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- Reference Information\".\"Creation Date\" s_18,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- Reference Information\".\"Previous Transaction Number\" s_19,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- Subledger Accounting Journals Details\".\"Journal Line Description\" s_20,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- Tax Details\".\"Tax Classification Code\" s_21,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"Business Unit\".\"Business Unit Name\" s_22,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"Business Unit\".\"Default Legal Entity Name\" s_23,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"Business Unit\".\"Default Set\" s_24,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"Legal Entity\".\"Legal Entity Address\" s_25,\r\n" + 
				"   DESCRIPTOR_IDOF(\"Receivables - Transactions Real Time\".\"- General Information\".\"Payment Terms Name\") s_26,\r\n" + 
				"   DESCRIPTOR_IDOF(\"Receivables - Transactions Real Time\".\"Business Unit\".\"Business Unit Name\") s_27,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- Line Amounts\".\"Quantity Credited\" s_28,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- Line Amounts\".\"Quantity Invoiced\" s_29,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- Tax Amounts\".\"Recoverable Tax Entered Amount\" s_30,\r\n" + 
				"   \"Receivables - Transactions Real Time\".\"- Transaction Amounts\".\"Transaction Entered Amount\" s_31\r\n" + 
