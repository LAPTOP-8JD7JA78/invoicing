...
//				"((\"- Reference Information\".\"Creation Date\" > timestamp '2022-05-08 05:00:00') AND (\"- Tax Details\".\"Tax Classification Code\" IS NOT NULL) AND (\"- General Information\".\"Transaction Number\" = '579115'))\n" + 
...
//				"((\"Standard Receipt Details\".\"Last Updated Date\" > timestamp '2021-01-01 00:00:00') AND (\"Standard Receipt Details\".\"Receipt Number\" IN ('PAGO01-8683', 'IME-24072201', 'IME-24072302', 'PAGO01-8682', 'PAGO01-8680', 'PAGO01-8676', 'PAGO01-8661', 'PAGO01-8658', 'PAGO01-8657', 'PAGO01-8656', 'PAGO01-8648', 'PAGO01-8647', 'PAGO01-8646', 'PAGO01-8644', 'PAGO01-8638', 'PAGO NUM 5743 ', 'PAGO NUM 33122', 'MEX2716219', 'MEX2701244', 'MEX2680203', 'MEX2659211', 'MEX24072603', 'MEX24072601', 'MEX24072402', 'MEX24072201', 'MEX24071901', 'MEX24071868', 'MEX24071802', 'MEX24071801', 'CAN24072575E', '12P270922043035287', '12DV35843036235', '12DV35542999291', '06PV35643007250', '06DV36043037293', '03PV35943030210', '02DV35342958264')))" +
//				"((\"Standard Receipt Details\".\"Last Updated Date\" > timestamp '2021-01-01 00:00:00') AND (\"Standard Receipt Details\".\"Receipt Number\" IN ('TAP2507186')))" +
...
//				"((\"Cost Transaction Details\".\"Transaction Date\" > timestamp '2024-08-01 08:22:35') AND (\"Cost Transaction Type\".\"Base Transaction Type Name\" IN ('Envio en transito', 'Envío entre organizaciones de orden de transferencia', 'Transferencia directa entre organizaciones', 'Intransit Shipment', 'Transfer Order Interorganization Shipment', 'Direct Organization Transfer')) AND (\"Cost Organization Book\".\"Cost Book Code\" = 'PRIMARIO') AND (DESCRIPTOR_IDOF(\"Costing - Cost Accounting Real Time\".\"Business Unit\".\"Business Unit Name\") = 300000002031066))\r\n"+
				"FETCH FIRST 75001 ROWS ONLY\r\n" + 
				"         </v7:sql>\r\n" + 
				"         <v7:outputFormat>XML</v7:outputFormat>\r\n" + 
				"         <v7:executionOptions>\r\n" + 
